...
if(canvas.getContext){
	...
	function getMousePos(evt){
		var newMouseX = evt.clientX - canvasPosition.left;
		var newMouseY = evt.clientY - canvasPosition.top;
		if(Math.abs(mouseX - newMouseX) > 100 && Math.abs(mouseY - newMouseY) > 100){
			draw();
		}		
		console.log(Math.abs(mouseX - newMouseX));
		console.log(Math.abs(mouseY - newMouseY)
		mouseX = newMouseX;
		mouseY = newMouseY;
